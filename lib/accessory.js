...
class HygrothermographAccessory {
  constructor(log, config) {
    ...
    this.timeout = (config.timeout !== undefined) ? config.timeout : defaultTimeout;
  ...
  get humidity() {
    if (this.hasTimedOut()) {
      this.log.debug(`[${this.config.address}] Accessory has timed out. Last update: ${this.lastUpdatedAt}`);
      return undefined;
    }
