...
class HygrothermographAccessory {
  constructor(log, config) {
    ...
    this.timeout =
      this.config.timeout == null ? defaultTimeout : this.config.timeout;
    this.fakeGatoEnabled = this.config.fakeGatoEnabled || false;
    this.forceDiscovering = this.config.forceDiscovering !== false;
    this.forceDiscoveringDelay = this.config.forceDiscoveringDelay;
    ...
    this.mqttClient = this.configureMQTTClient(this.config.mqtt);

    this.scanner = this.initializeScanner(this.config.address);
  ...
  initializeScanner(address) {
    const scanner = new Scanner(
      this.log,
      address,
      this.forceDiscovering,
      this.forceDiscoveringDelay
    );
